...
export WERCKER_SSH="ssh $WERCKER_SETUP_SSH_HOST -v -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -l $WERCKER_SETUP_SSH_USERNAME -i $WERCKER_SETUP_SSH_ID_FILE"
